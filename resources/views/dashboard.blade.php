    ...
    <!-- end of nav -->
        <div class="row mb-5">
            <div class="col-md-12 ">
                ...
                <h4 class="mx-5">Welcome Olumide</h4> 
    ...
    <!-- end of welcome page -->
        <div class="row ms-5 me-5 card_container">
                ...
                <div class="col-md-4 mb-3 ">
                    <div class="card" >
                        <!-- <img src="admin/uploads/<" class="img-fluid rounded" style="width:500px; height:400px;" alt="responsive image"> -->
                        <div class="card-body ">
                            <p class="fs-6 fw-bold lh-1"></p>
                            <div class="d-flex justify-content-between align-items-start">
                                <p class="fs-4 fw-bold lh-1 "></p>
                                <button class="btn btn-success round">Quick Buy</a></button>  
                            </div>
                        </div>
                    </div>
                </div>
